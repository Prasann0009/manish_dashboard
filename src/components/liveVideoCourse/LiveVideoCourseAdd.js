...
// import {toast,Bounce} from "react-toastify"
export default function LiveVideoCourseAdd () {
  const navigate = useNavigate();
 let [formval,setFormval]=useState({title:'',images:[], livevideoCategory:'',details:'',price:'',offerPrice:''})
 ...
 const handelOnChange=(e)=>{
  ...
  useEffect(()=>{
    const apiCall =async ()=>{
        let response=await fetch(`http://localhost:8080/api/livevideocoursescategory/allcourses`,{
          method: "GET",
        });
  ...
  const handelOnSubmit=(e)=>{
    e.preventDefault();
    console.log(formval);
    if(!formval.title || !formval.details || !formval.livevideoCategory || !formval.price || !formval.offerPrice){
    ...
    const apiCall =async ()=>{
      let response=await fetch("http://localhost:8080/api/livevideocourse/add",{
        method: "POST",
				body: postData,
      });
      const result=await response.json();
      ...
      if(!result.status){
        ...
        navigate("/live-video-course-list");
        ...
        <div className="row align-items-center">
          <div className="col-md-12">
            <ul className="breadcrumb">
              ...
              <li className="breadcrumb-item">
                <a href="">Live Video Course  Management
                  </a>
              </li>
              <li className="breadcrumb-item" aria-current="page">
              Live Video Course  Add
              </li>
            </ul>
          </div>
          <div className="col-md-12">
          ...
          <div className="card-body">
            <form onSubmit={handelOnSubmit}>
              <div className="row g-4">
                ...
                <div className="col-md-4">
                  <div className="form-floating mb-0">
                    <select className="form-select" name='livevideoCategory' onChange={handelOnChange} id="">
